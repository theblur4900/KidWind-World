...
def on_button_pressed_a():
    global max_val_tilt, best_angle_tilt, max_val_rotate, best_angle_rotate
    ...
    for i in range(181): # Tilt Logic
        ...
        if current_voltage_tilt > max_val_tilt:
            max_val_tilt = current_voltage_tilt
        best_angle_tilt = i
